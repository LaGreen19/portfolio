...
Tags: portfolio, gallery, portfolio list, responsive, drag and drop, templates, portfolio 1 column, portfolio 4 columns, portfolio archive, portfolio widget style, shortcode, newspapper, timeline, slider, carousel, custom post type
...
Check on the Portfolio Manager Lite:  [Demo site](http://otwthemes.com/demos/1ts/?item=Portfolio%20Manager%20Lite&utm_source=wp.org&utm_medium=page&utm_content=demo&utm_campaign=pm) | [Documentation page](http://otwthemes.com/online-documentation-portfolio-manager-lite/?utm_source=wp.org&utm_medium=page&utm_content=docs&utm_campaign=pm)
...
Get some more awesome **FREE plugins**: <a href="https://wordpress.org/plugins/blog-manager-light/" target="_blank">Blog Manager</a>, <a href="https://wordpress.org/plugins/widgetize-pages-light/" target="_blank">Widgetize Pages</a>, <a href="https://wordpress.org/plugins/content-manager-light/" target="_blank">Content Manager</a>
...
This plugin is [100% WPML compatible](https://wpml.org/?aid=20539&affiliate_key=qJ3LIXBmmhqR) too. 
...
Please refer to [online documentation page](http://otwthemes.com/online-documentation-portfolio-manager-lite/?utm_source=wp.org&utm_medium=page&utm_content=docs&utm_campaign=pm) for more details.
...
1. Grid - Portfolio 1 col
2. Grid - Portfolio 4 col
3. Image Left - Portfolio 1 column
4. Newspaper - Portfolio 3 columns
5. Widget Style - Image Left
6. Timeline
7. Slider 
8. Carousel 3 columns
9. Portfolio Manager menu
10. Add new item
11. Portfolio items list
12. Portfolio categories
13. Portfolio tags
14. Add portfolio list
15. Portfolio lists
16. Portfolio options
