...
?>
<div class="otw_portfolio_manager-slider  otw_portfolio_manager-carousel <?php echo $caption;?>" id="otw-pm-list-<?php echo $this->listOptions['id'];?>" data-animation="slide" data-item-per-page="3" data-item-margin="20" data-nav="<?php echo $this->listOptions['slider_nav'];?>" data-auto-slide="<?php echo $this->listOptions['slider-auto-scroll'];?>">
	<ul class="slides">
