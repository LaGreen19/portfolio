<?php  if( isset( $otw_pm_posts->posts ) ){?>
	...
	<?php }else{ ?>
		<?php _e( 'Related Projects', OTW_PML_TRANSLATION );?>
	<?php }?>
	</h3>
	<div class="otw_portfolio_manager-slider otw_portfolio_manager-carousel no-control-nav" data-animation="slide" data-item-per-page="<?php echo $details['otw_pm_related_posts_number']?>" data-item-margin="20">
		<ul class="slides">
						...
						<figure class="otw_portfolio_manager-portfolio-media otw_portfolio_manager-format-image otw_portfolio_manager-related-posts">
							...
							<div class="otw_portfolio_manager-portfolio-overlay">
								...
								<div class="otw_portfolio_manager-portfolio-icon-wrapper">
									...
									<a href="<?php echo $preview_image_href?>" class="otw_portfolio_manager-fancybox-img icon-search" title="Project Title #1"></a>
								</div>
								<!-- End Portfolio Icons -->
							</div>
