...
<?php if( !is_array( $postMetaData ) && ( $postMetaData == 'single' ) ){?>
	<h3 class="otw_portfolio_manager-mb25">
		...
		<?php }else{ ?>
			<?php _e( 'Hey, like this? Why not share it with a buddy?', OTW_PML_TRANSLATION )?>
		<?php }?>
	</h3>
<?php }?>
<div 
...
<?php if( $this->listOptions['show-social-icons'] == 'share_icons' ) : ?>
	...
	<?php if( !empty( $this->listOptions['show-social-icons-twitter'] ) ){?>
		<a class="otw_portfolio_manager-social-item otw-twitter" target="_blank" href="https://twitter.com/intent/tweet?source=tweetbutton&amp;text=<?php echo $socialTitle;?>&amp;url=<?php echo $socialLink;?>"><i class="icon-twitter" href=""></i></a>
	<?php }?>
	...
	<?php if( !empty( $this->listOptions['show-social-icons-linkedin'] ) ){?>
		<a class="otw_portfolio_manager-social-item otw-linkedin" target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $socialLink;?>&amp;title=<?php echo $socialTitle;?>&amp;summary=<?php echo $socialDescription;?>"><i class="icon-linkedin" href=""></i></a>
	<?php }?>
	<?php if( !empty( $this->listOptions['show-social-icons-pinterest'] ) ){?>
		<a class="otw_portfolio_manager-social-item otw-pinterest" target="_blank" href="http://pinterest.com/pin/create/button/?url=<?php echo $socialLink;?>&amp;media=<?php echo $socialAsset; ?>&amp;description=<?php echo $socialDescription;?>&amp;title=<?php echo $socialTitle;?>"><i class="icon-pinterest" href=""></i></a>
	<?php }?>
<?php endif;?>
<?php if( $this->listOptions['show-social-icons'] == 'share_btn_small' || $this->listOptions['show-social-icons'] == 'share_btn_large') : ?>
	...
	<?php if( !empty( $this->listOptions['show-social-icons-twitter'] ) ){?>
		<div class="otw_portfolio-manager-share-button-boxy">
			<a class="otw_portfolio-manager-social-share otw-twitter" target="_blank" href="https://twitter.com/intent/tweet?source=tweetbutton&amp;text=<?php echo $socialTitle;?>&amp;url=<?php echo $socialLink;?>"><i class="icon-twitter-sign"></i></a>
		</div>
	<?php }?>
	<?php if( !empty( $this->listOptions['show-social-icons-googleplus'] ) ){?>
		<div class="otw_portfolio-manager-share-button-boxy">
