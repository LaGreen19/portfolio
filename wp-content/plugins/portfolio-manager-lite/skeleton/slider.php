...
<section class="otw-twentyfour otw-columns" id="otw-pm-list-<?php echo $this->listOptions['id'];?>">
	<div class="otw_portfolio_manager-slider <?php echo $caption;?>" data-animation="slide" data-item-per-page="1" data-item-margin="" data-nav="<?php echo $this->listOptions['slider_nav'];?>" data-auto-slide="<?php echo $this->listOptions['slider-auto-scroll'];?>" >
		<ul class="slides">
