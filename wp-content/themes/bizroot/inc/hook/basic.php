...
if ( ! function_exists( 'bizroot_import_custom_css' ) ) :
	 ...
	 * @since 1.0.7
	 */
	function bizroot_import_custom_css() {
...
add_action( 'after_setup_theme', 'bizroot_import_custom_css', 99 );
