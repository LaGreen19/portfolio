...
<div class="main-image image-hover portfolio-project">

  <?php if($main_image) { ?>

		<a href="<?php the_permalink(); ?>"><?php echo wp_get_attachment_image( $main_image, $size ); ?>
	</a>
		<a href="<?php the_permalink(); ?>"><div class="image-hover-text"><?php echo $project_type; ?></div>
	</a>
  <?php } ?>
